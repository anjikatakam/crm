        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="import-export mt-3">
					...
					<?php if($this->session->userdata("adminrole")==1) { ?>
					<button class="btn import text-uppercase"><a href="<?php echo base_url();?>Advisors">List of Advisors</a></button>
					<?php } ?>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="bars d-flex align-items-center">
				 ...
				 ?>
                    <div class="list-item color1">
                        <a href="javascript:void(0);" onclick="showDetails('<?php echo $request['sr_request'];?>','<?php echo $request['title'];?>');"><p class="title">#WR  <?php echo $request['sr_request'];?></a>
						<i class="fas fa-edit editSrRequest" data-id="<?php echo $request['sr_request'];?>"></i></p>
						<p class="title"><?php echo $request['title'];?></p>
...
<script>
 function listView(){
	 var href="<?php echo base_url();?>Admin/adminList/";
			 ...
			 // alert(result);
			  ...
			  $.each(JSON.parse(result),function(index,value){
				  ...
				  if(value.created_by=="3"){
					  $(".msgrole").append(value.name+ "(Customer)");
				  }
     ...
     <div class="modal-body">
      <div class="showdetails">
        <div class="head d-flex align-items-center">
            ...
            <div class="due">
                <p class="mb-0 text-color-gray dueDateshow">Due in 1 day <<!--<i class="fas fa-circle ml-3"></i>-->
				</p>
            </div>
        </div>
         <div class="body">
